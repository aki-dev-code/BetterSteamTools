...
// failing module — the rest of BetterSteamTools keeps working.
static void ShowDownloadFailedPopup(const std::string& dllName,
                                    const std::string& sha256,
                                    const std::string& component)
{
    SteamDiagnostics::ShowWarning(
        "BetterSteamTools - Unsupported Steam Version",
        "BetterSteamTools: signature file not found for " + dllName + ".\n\n"
        ...
        "       <Steam>\\bettersteamtools\\pattern\\" + component + "\\" + sha256 + ".toml\n"
        "  3. Check upstream:\n"
        "       https://github.com/OpenSteam001/steam-monitor/tree/pattern/" + component + "\n"
        "  4. Report the diagnostics below:\n"
        "       https://github.com/OpenSteam001/BetterSteamTools/issues");
}
...
void ReportMissingFunctions()
{
    ...
    SteamDiagnostics::ShowWarning(
        "BetterSteamTools - Missing Signatures",
        "BetterSteamTools: some functions could not be located.\n\n"
