...
//
// General macros  →  <steam>/bettersteamtools/main.log
// Module macros   →  <steam>/bettersteamtools/<module>.log
//
...
#else  // BETTERSTEAMTOOLS_LOGGING_ENABLED
...
// Generated header has its own #ifdef BETTERSTEAMTOOLS_LOGGING_ENABLED guard.
